...
import { idlFactory } from './jumba-a-art-backend.did.js';
export { idlFactory } from './jumba-a-art-backend.did.js';
// CANISTER_ID is replaced by webpack based on node environment
export const canisterId = process.env.CANISTER_ID_JUMBA_A_ART_BACKEND;
 ...
 * @return {import("@dfinity/agent").ActorSubclass<import("./jumba-a-art-backend.did.js")._SERVICE>}
 */
...
/**
 * A ready-to-use agent for the jumba-a-art-backend canister
 * @type {import("@dfinity/agent").ActorSubclass<import("./jumba-a-art-backend.did.js")._SERVICE>}
 */
export const jumba_a_art_backend = createActor(canisterId);
